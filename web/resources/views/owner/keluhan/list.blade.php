                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-grey">
                                ...
                                <td>{{ $k['nokamar'] }}</td>
                                <td>
                                    <a href="{{ route('owner.editkeluhan', $k['kode']) }}"><button type="button" class="btn btn-warning waves-effect">Edit</button></a>
    ...
    <div class="modal-dialog model-lg" role="document">
        <div class="modal-content modal-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}">
            <div class="modal-header">
                <span class="right"><button type="button" data-dismiss="modal" class="form-control bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect" style="border-radius: 0px; border: none; box-shadow: none;"><i class="material-icons">close</i></button></span>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="form-group form-float">
                                    ...
                                    <br>
                                    <span class="right"><button type="button" class="btn bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect" onclick="tambahkomen()">POST NOTE</button></span>
                                    <br>
                                </div>
                            </div>
                        </div>
