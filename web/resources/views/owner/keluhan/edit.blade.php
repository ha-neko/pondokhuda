        ...
        <div class="card">
            ...
            <div class="body">
                <fieldset>
                    ...
                    <form id="form" action="{{ route('owner.updatekeluhan', $kodes) }}" method="post">
                        @csrf
                    <div class="form-group form-float">
                        <div class="form-line">
                            <div class="demo-checkbox">
                                ...
                                @foreach ($k['status'] as $s)
                                    ...
                                    <input type="checkbox" id="md_checkbox_31" class="filled-in chk-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" disabled="" name="pelaporan" checked />
                                    ...
                                    <input type="checkbox" id="md_checkbox_32" class="filled-in chk-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" disabled="" name="dikerjakan" checked />
                                    ...
                                    <input type="checkbox" id="md_checkbox_33" class="filled-in chk-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" disabled="" name="selesai" checked />
                                ...
                                @endforeach -->
                                @if (in_array("Pelaporan", $status))
                                <input type="checkbox" id="md_checkbox_31" class="filled-in chk-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" name="pelaporan" required />
                                <label for="md_checkbox_31">Pelaporan</label><br>
                                @endif
                                @if (in_array("Dikerjakan", $status))
                                <input type="checkbox" id="md_checkbox_32" class="filled-in chk-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" name="dikerjakan" value="Dikerjakan" required />
                                <label for="md_checkbox_32">Dikerjakan</label><br>
                                @endif
                                @if (in_array("Selesai", $status))
                                <input type="checkbox" id="md_checkbox_33" class="filled-in chk-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" name="selesai" value="Selesai" disabled="true" />
                    ...
                    <div class="text-right">
                            ...
                            <button id="btnUpdate" class="btn bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect" type="submit" onclick="load()"><i class="material-icons">present_to_all</i> <span class="icon-name">Update</span></button>
                    </div>
                    </form>
                    @else
                    ...
                    @endif
                        ...
                        <div class="col-xs-6 align-right">
                            <!-- <a href="#">
                            <button class="btn bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect" type="button"><i class="material-icons">chat</i> <span class="icon-name">Chat</span></button>
                            </a> -->
                        </div>
                    </div>
                </fieldset>
...
function load() {
    if (document.getElementById("md_checkbox_33").disabled == true && document.getElementById("md_checkbox_32").checked == true) {
