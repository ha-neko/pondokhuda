                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form onSubmit="return validate()" id="form" action="{{route('owner.kost-create')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <label class="form-label">Warna Utama Aplikasi</label>
                            ...
                            <span class="right">
                                <button type="submit" onclick="load()" class="btn btn-link waves-effect">TAMBAH KOST</button>  
