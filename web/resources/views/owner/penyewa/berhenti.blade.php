            ...
            <fieldset>
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="body">
        						<form onSubmit="return validate()" id="form" action="{{ route('owner.penyewaberhentisewa') }}" method="post">
        						@csrf
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button type="submit" class="btn waves-effect bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" id="btnsmt" onclick="load()"><i class="material-icons">check</i><span class="icon-name">Berhenti Sewa</span></button>
                                    </div>
                                    <br>
                                </form>
                                </div>
