...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <form onSubmit="return validate()" id="form" action="{{route('owner.createpenyewa')}}" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button type="submit" class="btn waves-effect bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" onclick="load()"><i class="material-icons">check</i> <span class="icon-name">Tambah Penyewa</span></button>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
...
function validate() {
    var validate = true;
    $("#form input[type=text], #form input[type=number], #form input[type=email]").each(function(){
