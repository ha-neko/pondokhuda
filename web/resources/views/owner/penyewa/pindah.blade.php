...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <form onSubmit="return validate()" id="form" action="{{ route('owner.pindahkamar') }}" method="post">
                <div class="body">
                    @csrf
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            ...
                            <div id="showBaru" style="display: none;">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <span class="right">
                                            <button class="btn bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect" type="submit" onclick="load()"><i class="material-icons">directions_run</i> <span class="icon-name">Pindah</span></button>
                                        </span>
                                    </div>
                                </fieldset>
                            </div>
...
$(document).on("change", "#nomorkamar", function(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ route('owner.getdatasewakamar') }}",
...
function test(){
    ...
    $.ajax({
        type : "post",
        url  : "{{ route('owner.getkamarpindah') }}",
