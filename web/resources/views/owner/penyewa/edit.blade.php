            ...
            <fieldset>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
        						<form onSubmit="return validate()" id="form" action="{{ route('owner.updatepenyewa', $kode) }}" method="post" enctype="multipart/form-data">
        						@csrf
        						<center>
                                ...
                                <fieldset>
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line disabled">
                                            <input type="text" id="noktp" class="form-control disabled" name="noktp" placeholder="Masukkan nomor KTP" value="{{ $p['noktp'] }}">
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-line" >
                                            <input type="text" id='datePicker' class="form-control" name="tgllhr" placeholder="Masukkan tanggal lahir" value="{{ $p['tgllahir'] }}">
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                ...
                                <fieldset>
                                    ...
                                    <a onclick="editDomisili()">
        								<button class="btn bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect" id="editDomisili" type="button"><i id="iconbtn" class="material-icons">mode_edit</i> <span id="btned" class="icon-name">Edit Domisili</span></button>
                                ...
                                <div class="text-right">
							        ...
							        <button class="btn waves-effect bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}" type="button"><i class="material-icons">keyboard_arrow_left</i> <span class="icon-name">Kembali</span></button>
							        </a>
	                                <button class="btn bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect" type="submit" onclick="load()"><i class="material-icons">file_upload</i> <span class="icon-name">Update</span></button>
                            	</div>
        						</form>
                            </div>
                        </div>
...
function editDomisili() {
	if (c == false) {
		...
		document.getElementById("editDomisili").className = "btn bg-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}} waves-effect";
