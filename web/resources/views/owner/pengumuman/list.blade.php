            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            @if($pengumumans['pengumuman'] != 'error')
                            @foreach($pengumumans['pengumuman'] as $news)
                            ...
                            <tr class="bg-grey">
                                ...
                                <td>{{ $news['status'] }}</td>
                                <td>
                                    <a href="{{route('owner.editpengumuman', $news['kode'])}}">
...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-col-{{Auth::user()->ownerkost[$indexKost]['kost']['name_color']}}">
            ...
            <form onSubmit="return validate()" id="form" action="{{route('owner.createpengumuman')}}" method="POST" enctype="multipart/form-data">
                @csrf
