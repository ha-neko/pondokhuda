        ...
        <div class="card">
            ...
            <div class="body">
                <div class="table-responsive">
                    ...
                    <form action="{{ route('admin.editpengumuman') }}" method="post">@csrf
                    @if ($b['kode'] == $kode)
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="text-right">
                            ...
                            <button class="btn bg-{{Auth::user()->adminkost[$indexKost]['kost']['name_color']}} waves-effect" type="submit" onclick="load()"><i class="material-icons">present_to_all</i> <span class="icon-name">Update</span></button> 
                        </div>
                    </div>
                    @endif
                    @endforeach
