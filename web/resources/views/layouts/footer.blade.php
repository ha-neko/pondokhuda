    ...
    <!-- Morris Plugin Js -->
    <script src="{{{ URL::asset('adminbsb/plugins/raphael/raphael.min.js')}}}"></script>
    ...
    <script src="{{{ URL::asset('adminbsb/plugins/jquery-datatable/extensions/export/natural_sort.min.js')}}}"></script>
    <script src="{{{ URL::asset('adminbsb/plugins/jquery-datatable/extensions/export/date_euro.min.js')}}}"></script>
